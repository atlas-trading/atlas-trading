...
_ARB_TICKERS = {
    "BTC/USDT": {"timestamp": _TS, "bid": 50000, "ask": 50000, "last": 50000},
    "ETH/BTC": {"timestamp": _TS, "bid": 0.06, "ask": 0.06, "last": 0.06},
    "ETH/USDT": {"timestamp": _TS, "bid": 3200, "ask": 3200, "last": 3200},
}

# 공정 가격 — spread 적용, 차익 없음
_FAIR_TICKERS = {
    "BTC/USDT": {"timestamp": _TS, "bid": 49999, "ask": 50001, "last": 50000},
    "ETH/BTC": {"timestamp": _TS, "bid": 0.05999, "ask": 0.06001, "last": 0.06},
    "ETH/USDT": {"timestamp": _TS, "bid": 2999, "ask": 3001, "last": 3000},
}
...
async def test_partial_then_full_prices_trigger_signal():
    ...
    await runner.on_tickers(
        {
            "ETH/BTC": {"timestamp": _TS + 1, "bid": 0.06, "ask": 0.06, "last": 0.06},
        }
    )
    assert len(sm.started) == 1
