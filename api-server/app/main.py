...
from app.api.v1 import backtests, strategies, parameter_optimization, market, paper_trading, environment, deployment, secrets
...
app.include_router(
    ...
    prefix=f"{settings.api_prefix}/paper-trading",
    tags=["paper-trading"],
)
